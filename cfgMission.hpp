class cfgMission {
    ...
    vipObjectiveTimeoutDefault = 150;                                           // Zeit in Sekunden, die der VIP in einem Objective stehen muss, um es zu erfüllen. Solange nicht von Funktion überschrieben.
    ...
    vipBaseTaskTimeout = 300;                                                   // Zeit in Sekunden, die der VIP zum Schluss der Mission in seiner Basis verbringen muss, bevor Blufor gewinnt.
