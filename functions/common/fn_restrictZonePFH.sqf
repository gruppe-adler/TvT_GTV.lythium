...
[{
    ...
    if (alive player && {!(player inArea _area)}) exitWith {
        ["gtv_notification1",["MELDUNG","Zurück in die Spielzone!"]] call bis_fnc_showNotification;
        ...
        [{
            if !(player inArea _this) then {
                ...
                ["gtv_notification1",["MELDUNG","Du bist zurück in der Spielzone."]] call bis_fnc_showNotification;
            };
